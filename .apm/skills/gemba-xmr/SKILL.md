...
`gemba-xmr` reads a CSV of dated observations, computes Wheeler/Vacanti XmR
...
- Listing available metrics — `npx gemba-xmr list observations.csv`
- Validating CSV schema — `npx gemba-xmr validate observations.csv`
...
Validate before analysis: `npx gemba-xmr validate observations.csv`
